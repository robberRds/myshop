                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 d-none d-lg-block">
                        <div class="main-menu text-center">
                            <nav>
                                <ul>
                                    <li><a href="{{route('food-shop/index')}}">HOME</a>
                                        <ul class="submenu">
                                            <li>
                                                <a href="{{route('food-shop/index')}}">home version 1</a>
                                            </li>
                                            <li>
                                                <a href="{{route('food-shop/index-2')}}">home version 2</a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul class="mega-menu">
                                            <li>
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('food-shop/shop-page')}}">Grapes & Raisins</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <ul>
                                            ...
                                            <li>
                                                <ul>
                                                    <li><a href="{{route('food-shop/shop-page')}}"><img alt="" src="../../../public/img/banner/menu-img-4.jpg"></a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="{{route('food-shop/blog-leftsidebar')}}">Blog</a>
                                        <ul class="submenu">
                                            <li>
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-4.jpg"></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-5.jpg"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-meta">
                                            <ul>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-6.jpg"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-meta">
                                            <ul>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-7.jpg"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-meta">
                                            <ul>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-8.jpg"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-meta">
                                            <ul>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-9.jpg"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-meta">
                                            <ul>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="blog-wrapper mb-30 gray-bg">
                                    <div class="blog-img hover-effect">
                                        <a href="blog-details.blade.php"><img alt="" src="../../../public/img/blog/blog-10.jpg"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-meta">
                                            <ul>
